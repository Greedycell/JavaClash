...
public class Player {
   ...
   private Player(int id) {
      this.id = id;
      this.home = new LogicJsonObject("Gamefiles/starting_home.json");
   }
   ...
   public static Player load(int id) {
      ...
      return !players.containsKey(id) ? null : (Player)players.get(id);
   }
   ...
   public void LogicClientAvatar(Writer writer) {
      ...
      writer.writeInt(100000);
      writer.writeInt(3);
      writer.writeInt(4000005);
      writer.writeInt(10);
      writer.writeInt(4000006);
      writer.writeInt(5);
      writer.writeInt(4000059);
      writer.writeInt(1);
      writer.writeInt(0);
      writer.writeInt(0);
      writer.writeInt(0);
